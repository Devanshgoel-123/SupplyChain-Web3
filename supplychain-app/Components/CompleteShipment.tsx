...
import { completeShipment } from "@/Functions/functions";
...
export default function completeShipmentComp({onClose}:CompShippingProps){
    const [completeShipmentObject,setCompleteShipmentObject]=useState<completeShipmentInterface>({
        receiver:"",
        index:0
    })
    const completeShipping=async ()=>{
        await completeShipment(completeShipmentObject);
    }
    return (
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="relative mt-3">
              <input
                ...
                onChange={(e) => setCompleteShipmentObject({
                    ...completeShipmentObject,
