    ...
    <div className="flex items-center justify-center min-h-screen px-4 py-8">
      <div className="relative w-full max-w-lg p-6 mx-auto bg-white rounded-md shadow-lg">
        ...
        <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
          ...
          <h5 className="font-medium text-gray-800 mb-1 text-xl dark:text-white">
           Welcome User
          </h5>
          ...
          <div className="flex mt-4 space-x-3 md:mt-6">
            <a
            href="#"
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-black rounded-lg border-2">Balance : 35ETH
            </a>
            <a
            href="#"
